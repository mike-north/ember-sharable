...
test('visiting /home', function(assert) {
  ...
  andThen(function() {
    ...
    assert.equal(document.querySelectorAll('meta[name="twitter:title"]')[0].content, 'Another thing', 'Correct twitter:title content');
    assert.equal(document.querySelectorAll('meta[name="twitter:description"]')[0].content, 'Rich metadata for sharing pages on Ember.js apps', 'Correct twitter:description content');
  ...
  andThen(function() {
    ...
    assert.equal(document.querySelectorAll('meta[name="twitter:card"]').length, 1, 'One twitter:card tag');
    assert.equal(document.querySelectorAll('meta[name="twitter:title"]').length, 1, 'One twitter:title tag');
    assert.equal(document.querySelectorAll('meta[name="twitter:title"]')[0].content, 'Home Route', 'Correct twitter:title content');
  });
});
